  ...
  <!--include files find the nav bar and then the require files connect to the database and/or find errors -->
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread header-edit">Collections</h1>
          </div>
        </div>
      </div>
    </div>
	<!--sets up container for collections -->
    <section class="ftco-section">
		...
		<div class="row justify-content-center">
			...
			<?php 
			//session display for users 
		if(!isset($_SESSION['user'])){
			echo '<div class="col-md-12 heading-section text-center ftco-animate">
			<span class="subheading add-col-heading">Have something interesting?</span>
            <p>If you want to add to our collections then please <a href="login.php">Sign in</a> to see the details</p>
			</div>
			<br><br><br><br>';
		} else{
		echo '';
		...
		<!--unlisted order -->
			...
			<!--form for users searching for collection -->
			  ...
			  if ( $result->num_rows > 0 ) {
				...
				<div class="product product-edit">
					...
					<div class="text py-3 pb-4 px-3 text-center">
						...
						<div class="d-flex">
							<div class="pricing">
								<p class="price category"><span>' .$row['category']. '</span></p>
							</div>
						</div>
