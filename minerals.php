      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">Minerals</h1>
          </div>
        </div>
      </div>
    </div>
	<!--container to display collections -->
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
					<!--filter option to change cateogry -->
    				<ul class="product-category">
    					<li><a href="collections.php">All</a></li>
    					<li><a href="fossils.php">Fossils</a></li>
    					<li><a href="minerals.php" class="active">Minerals</a></li>
			...
			$sql = "SELECT * FROM collections WHERE category LIKE '%Mineral%' ";
